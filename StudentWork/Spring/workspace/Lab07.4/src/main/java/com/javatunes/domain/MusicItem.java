...
public class MusicItem {
	...
	public MusicItem(MusicItem itemIn) {
		setId(itemIn.getId());
		setTitle(itemIn.getTitle());
		setArtist(itemIn.getArtist());
		setReleaseDate(itemIn.getReleaseDate());
		setPrice(itemIn.getPrice());
		setMusicCategory(itemIn.getMusicCategory());
	}
